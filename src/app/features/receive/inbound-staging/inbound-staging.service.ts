...
export class InboundStagingService {
  ...
  getJSON(): Observable<any> {
    return this.httpClient.get('../../../assets/iStagingRes.json');
  }
  ...
  getLocation(tallyNumber: any, location: any): Observable<any> {
    return this.httpClient
      .post<any>(this.url+'/receiving/location', {
        tallyNumber,
        location,
      })
      .pipe(retry(1), catchError(this.httpError));
  ...
  getData(
    ...
    return this.httpClient
      .post<any>(this.url+'/receiving/data', {
        tallyNumber,
        location,
        lot1,
        lot2,
